...
const Navbar = () => {
  ...
  // state variable
  const [showMobileMenu, setShowMobileMenu] = useState(false); // false means mobile-menu will be hidden by default



  // to prevent mobile-menu from scrolling whenever the mobile menu is open
