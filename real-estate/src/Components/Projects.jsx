...
const Projects = () => {
  ...
  useEffect(() => {
    const updateCardsToShow = ()=> {
      if(window.innerWidth >= 1024){  // for full-screen
        setCardsToShow(projectsData.length);
      }  else {
        setCardsToShow(1); // for mobile-phones- tablets etc
      }
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'> Our 
        <span className='underline underline-offset-4 decoration-1 under font-light'> Milestone Projects! </span></h1>
